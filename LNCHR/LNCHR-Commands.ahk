...
if ((input == "todo") and (UsingAnyWorkcomputer)) ; Work View Tasks (Outlook) 
{
close_lngui()
tryrun('"C:\Program Files (x86)\Microsoft Office\root\Office16\OUTLOOK.EXE" /select outlook:tasks')
return
}

if ((input == "cal") and (UsingAnyWorkcomputer)) ; Work Calendar (Outlook) 
{
close_lngui()
tryrun('"C:\Program Files (x86)\Microsoft Office\root\Office16\OUTLOOK.EXE" /select outlook:calendar')
return
}
...
{
close_lngui()
tryrun('"C:\Program Files (x86)\Microsoft Office\root\Office16\OUTLOOK.EXE" /select outlook:inbox')
return
}
...
if input == "/todo" ; View Tasks (Outlook) 
{
close_lngui()
TryCatchOutlook("Tasks",'"C:\Program Files (x86)\Microsoft Office\root\Office16\OUTLOOK.EXE" /select outlook:tasks')
return
}
...
if input == "/o" ; Office Commands`ntodo (View Tasks)`ncom (Compose New Email) 
{
lngui_enable_query("Office Commands todo (View Tasks) com (Compose New Email)", make_run_ReplaceTexts_func())
return
}
