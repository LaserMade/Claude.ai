...
Class classAutoPath {
	...
	__New(onComplete := "", defaultPath := "", guiShowOpt := "w600") {
		...
		this.editBox.move("x5 w" (this.gui.GetPos.w-10), true)
		this.displayBox.move("x5 w" (this.gui.GetPos.w-10), true)
	...
	;User presses ENTER
	enterKey() {
		this.selectedText := ControlGetChoice("Edit1", "ahk_id " this.gui.hwnd)
