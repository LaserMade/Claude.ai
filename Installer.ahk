...
str := A_AppData
newstr := (RegExReplace(str, "i)\\Roaming")) . "\Local\Programs\AutoHotkey"
A_LocalPrograms := Trim(newstr, " ")
DefaultPath := A_LocalPrograms
