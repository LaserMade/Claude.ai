...
; Thanks to DigiDon and just me for RichEdit Ole Callback.
; Edited January, 2018
; ======================================================================================================================
#NoEnv
SetBatchLines, -1
...
; Style buttons
Gui, Font, Bold, Arial
Gui, Add, Picture, xm y3 w20 h20 vBTSTB gSetFontStyle, .\Image\font_bold.bmp
Gui, Font, Norm Italic
Gui, Add, Picture, x+2 yp wp hp vBTSTI gSetFontStyle, .\Image\font_italic.bmp
Gui, Font, Norm Underline
Gui, Add, Picture, x+2 yp wp hp vBTSTU gSetFontStyle, .\Image\font_underline.bmp
Gui, Font, Norm Strike
Gui, Add, Picture, x+2 yp wp hp vBTSTS gSetFontStyle, .\Image\Strikethrough.png
Gui, Font, Norm, Arial
Gui, Add, Picture, x+2 yp wp hp vBTSTH gSetFontStyle, .\Image\superscript.png
Gui, Add, Picture, x+2 yp wp hp vBTSTL gSetFontStyle, .\Image\subscript.png
Gui, Add, Picture, x+2 yp wp hp vBTSTN gSetFontStyle, .\Image\broom.png
Gui, Add, Picture, x+10 yp wp hp vBTTXC gBTextColor, .\Image\textcolor48.png
Gui, Add, Picture, x+2 yp wp hp vBGC gBackGroundColor, .\Image\colorpalette48.png
Gui, Add, Picture, x+2 yp wp hp vBTBGC gBTextBkColor, .\Image\fillcolor48.png
Gui, Add, Edit, x+10 yp w150 hp ReadOnly vFNAME, %FontName%
Gui, Font, Bold, MS Comic Sans
Gui, Add, Button, x+0 yp w25 hp vBTCHF gChooseFont, F
Gui, Font
Gui, Add, Edit, x+5 yp vFSIZE ReadOnly, 8888
Gui, Add, UpDown, gChangeSize vUDVAL range4-120, 10
;Gui, Add, Picture, x+5 yp gSettings505, .\Image\settings.ico
...
Gui, Add, Picture, x10 y+1 w20 h20 vBTTAL gAlignLeft, .\Image\align_left.bmp
;Gui, Add, Button, x+0 yp wp hp vBTTAC gAlignCenter, ><
Gui, Add, Picture, x+2 yp wp hp vBTTAC gAlignCenter, .\Image\align_center.bmp
;Gui, Add, Button, x+0 yp wp hp vBTTAR gAlignRight, >|
Gui, Add, Picture, x+2 yp wp hp vBTTAR gAlignRight, .\Image\align_right.bmp
;Gui, Add, Button, x+0 yp wp hp vBTTAJ gAlignJustify, |<>|
Gui, Add, Picture, x+2 yp wp hp vBTTAJ gAlignJustify, .\Image\align_none.bmp
...
Gui, Add, Picture, x+2 yp wp hp gIndentation, .\Image\format_indent.bmp
Gui, Add, Picture, x+2 yp wp hp gResetIndentation, .\Image\format_outdent.bmp
Gui, Add, Picture, x+30 yp wp hp, .\Image\spacing-button.png
Gui, Add, Edit, x+5 yp vLSPC ReadOnly, 1111
Gui, Add, UpDown, gChangeLS vLSVAL range1-5, 1
; RichEdit #2
Gui, Font, s10, Arial
